...
func NewServiceProviderProcessor(handler ServiceProvider) *ServiceProviderProcessor {
	...
	self8 := &ServiceProviderProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self8.processorMap["Request"] = &serviceProviderProcessorRequest{handler: handler}
	self8.processorMap["Send"] = &serviceProviderProcessorSend{handler: handler}
	return self8
}
