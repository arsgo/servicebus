...
//  - ServiceName
//  - Input
func (p *ServiceProviderClient) Request(serviceName string, input string) (r string, err error) {
...
func (p *ServiceProviderClient) sendRequest(serviceName string, input string) (err error) {
...
func NewServiceProviderProcessor(handler ServiceProvider) *ServiceProviderProcessor {
	...
	self4 := &ServiceProviderProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self4.processorMap["Request"] = &serviceProviderProcessorRequest{handler: handler}
	return self4
}
